...
int main() {
    using pdw::FindInvalidTextFilterCaret;
    ...
    expect(FindInvalidTextFilterCaret("^BRAND;^GRIP 1", false) == std::string::npos,
           "caret valid at start of each alternative");
    expect(FindInvalidTextFilterCaret("BRAND; ^GRIP 1", false) == std::string::npos,
           "caret valid after visual whitespace following semicolon");
    expect(FindInvalidTextFilterCaret("BRAND;GRIP ^1", false) == 11,
           "caret rejected inside alternative");
    expect(FindInvalidTextFilterCaret("^^BRAND", false) == 1,
           "second caret in one alternative rejected");
    expect(FindInvalidTextFilterCaret("BRAND^", false) == 5,
           "legacy interior caret rejected");
    expect(FindInvalidTextFilterCaret("BRAND^;GRIP", true) == std::string::npos,
           "exact-message mode keeps caret literal");
