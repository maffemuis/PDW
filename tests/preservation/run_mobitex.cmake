if(NOT DEFINED PDW_EXECUTABLE OR NOT DEFINED COMPARE_EXECUTABLE OR NOT DEFINED PYTHON_EXECUTABLE OR NOT DEFINED SOURCE_DIR OR NOT DEFINED OUTPUT_DIR)
    message(FATAL_ERROR "MOBITEX preservation runner is missing required paths")
endif()

file(MAKE_DIRECTORY "${OUTPUT_DIR}")

set(FIXTURE "${OUTPUT_DIR}/mobitex-basic.wav")
set(CAPTURE "${OUTPUT_DIR}/mobitex-basic.full.jsonl")
set(ACTUAL "${OUTPUT_DIR}/mobitex-basic.actual.jsonl")
set(EXPECTED "${SOURCE_DIR}/tests/preservation/golden/mobitex-basic.jsonl")
set(GENERATOR "${SOURCE_DIR}/tests/preservation/generate_mobitex_fixture.py")
...
if(NOT GENERATOR_RESULT EQUAL 0)
    message(FATAL_ERROR "MOBITEX fixture generation failed (${GENERATOR_RESULT})\n${GENERATOR_OUTPUT}\n${GENERATOR_ERROR}")
endif()
...
execute_process(
    COMMAND "${CMAKE_COMMAND}" -E env
        "PDW_PRESERVATION_PROTOCOL=mobitex"
...
if(NOT REPLAY_RESULT EQUAL 0)
    message(FATAL_ERROR "PDW MOBITEX replay failed (${REPLAY_RESULT})\n${REPLAY_OUTPUT}\n${REPLAY_ERROR}")
endif()
...
if(NOT COMPARE_RESULT EQUAL 0)
    ...
    message(FATAL_ERROR
        "MOBITEX golden comparison failed (${COMPARE_RESULT})\n"
        "Expected:\n${EXPECTED_TEXT}\n"
        "Actual:\n${ACTUAL_TEXT}\n"
        "Comparator:\n${COMPARE_OUTPUT}\n${COMPARE_ERROR}")
endif()

message(STATUS "MOBITEX preservation replay matched golden output")
