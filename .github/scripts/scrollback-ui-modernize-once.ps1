...
Replace-Exact $anchor $insert 'scrollback modern surface insertion'
...
git rm .github/workflows/scrollback-ui-modernize-once.yml .github/scripts/scrollback-ui-modernize-once.ps1
git add $path
git diff --cached --check
if ($LASTEXITCODE -ne 0) { throw 'cached diff check failed' }
git commit -m 'Modernize Scrollback and pane sizes dialog presentation'
