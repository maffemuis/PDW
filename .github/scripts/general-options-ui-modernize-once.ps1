...
Replace-Exact $anchor $insert 'general options modern surface insertion'
...
git rm .github/workflows/general-options-ui-modernize-once.yml .github/scripts/general-options-ui-modernize-once.ps1
git add $path
git diff --cached --check
if ($LASTEXITCODE -ne 0) { throw 'cached diff check failed' }
git commit -m 'Modernize General Options dialog presentation'
