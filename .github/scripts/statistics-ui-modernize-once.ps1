...
Replace-Exact $anchor $insert 'statistics modern surface insertion'
...
git rm .github/workflows/statistics-ui-modernize-once.yml .github/scripts/statistics-ui-modernize-once.ps1
git add $path
git diff --cached --check
if ($LASTEXITCODE -ne 0) { throw 'cached diff check failed' }
git commit -m 'Modernize Statistics dialog presentation'
